...
<footer id="footer" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
	...
	<div class="container">
		...
		if ( ! empty( $zerif_socials_facebook ) || ! empty( $zerif_socials_twitter ) || ! empty( $zerif_socials_linkedin ) || ! empty( $zerif_socials_behance ) || ! empty( $zerif_socials_dribbble ) ||
			...
			echo '<div class="zerif-copyright-box"><a class="zerif-copyright" rel="nofollow">TonmoyBlog </a>' . sprintf( __( 'developed by %s', 'zerif-lite' ), '<a class="zerif-copyright" href="' . esc_url( 'https://themeisle.com' ) . '" ' . $attribut_new_tab . ' rel="nofollow">' . __( 'Tanmay', 'zerif-lite' ) . '</a>' ) . '</div>';
